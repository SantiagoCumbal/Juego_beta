...
func _ready():
	if weapon_data == null:
		...
		weapon_data.weapon_name = "GLOCK"
		weapon_data.actual_bullets = 12
		weapon_data.max_bullets = 12
		...
		weapon_data.impact_scene = preload("res://Guns/Bullets/GLOCK-Bullet.tscn")
		weapon_data.gun_sound = preload("res://Guns/sounds/retro-gun-shot.mp3")
		if not weapon_data.gun_reload_sound:
			weapon_data.gun_reload_sound = preload("res://Guns/sounds/retro-gun-shot.mp3")
