...
func _ready():
	if weapon_data == null:
		...
		weapon_data.weapon_name = "AK47"
		weapon_data.actual_bullets = 30
		weapon_data.max_bullets = 30
		weapon_data.fire_rate = 0.1
		weapon_data.continuos_shooting = true
		weapon_data.bullet_speed = 2500
		weapon_data.damage = 15
		weapon_data.impact_scene = preload("res://Guns/Bullets/AK47-Bullet.tscn")
		weapon_data.gun_sound = preload("res://Guns/sounds/rifle.wav")
